    ...
    <section id="aboutPage">
      ...
      <div id="aboutText">
        <p>
          ...
          together gaming networks in high school to teaching computers in high
          school, working with and learning about tech has always been close at
          hand.
        </p>
        <br/>
        <p>
        ...
        <br />
        <p>
          I live and wish to work in the Eugene, Oregon area, so if you happened
          to have stumbled by this, please feel free to reach out to me by any
          of the below social medias, or by email, mckelveygreg@gmail.com
        </p>
      </div>
    </section>
  );
